...
namespace puc.poc.modulo.agenda.hostservice.writemodel.Extensions
{
    public static class ConfigureServicesExtensions
    {
        public static IServiceCollection AddKafkaBus(this IServiceCollection services)
        {
            ...
            services.InstallKafka("localhost", 9092, "financeiro-topic", consumerTypes, "financeiro-write-console");

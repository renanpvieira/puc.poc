...
namespace puc.poc.modulo.associado.hostservice.writemodel.Extensions
{
    public static class ConfigureServicesExtensions
    {
        public static IServiceCollection AddKafkaBus(this IServiceCollection services)
        {
            ...
            services.InstallKafka("localhost", 9092, "associado-topic", consumerTypes, "associado-write-console");

...
namespace puc.poc.modulo.servico.hostservice.readmodel.Extensions
{
    public static class ConfigureServicesExtensions
    {
        public static IServiceCollection AddKafkaBus(this IServiceCollection services)
        {
            ...
            services.InstallKafka("localhost", 9092, "servico-topic", consumerTypes, "servico-read-console");
